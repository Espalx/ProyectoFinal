...
namespace EmanuelBarrazaAppV1.Repositories
{
     internal static class ManejadorProducto
    {
        public static string connetionString = @"Data Source=EMANUEL\SISTEMAGESTION;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
